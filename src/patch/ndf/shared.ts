...
export function wrapAddedSnippetWithMarkers(
  ...
  return wrapSnippetWithMarkers(snippet, indent, markerContext, leadingComment);
}
...
export function wrapSnippetWithMarkers(
  ...
  const commentBlock = renderLeadingOperationComment(leadingComment, indent);
...
export function renderLeadingOperationComment(comment: string | undefined, indent: string): string {
