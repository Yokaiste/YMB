import { z } from 'zod';
import type { BulkEdit, BulkMatch, BulkOperation } from '../types.ts';
...
const conditionSchema = z
  .strictObject({
    ...
    is: z.enum(['startsWith', 'endsWith', 'contains', 'notContains', 'equals', 'notEquals']),
