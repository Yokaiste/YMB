...
type BuilderProjectConfigInput = {
  ...
  variables?: BuilderProjectConfig['variables'];
  mods?: BuilderProjectConfig['mods'];
  paths?: {
  ...
  mods: z
    .record(
      ...
      customizationSchema.extend({
        patches: z.record(identifierText, customizationSchema).optional(),
      }),
    )
    .optional(),
  paths: z
