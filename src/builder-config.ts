...
export interface BuilderProjectConfig {
  ...
  mods?: Record<string, ModCustomization> | undefined;
}
...
interface ModCustomization extends ConfigCustomization {
  patches?: Record<string, ConfigCustomization> | undefined;
}
