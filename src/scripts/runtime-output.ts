...
export function normalizeScriptOutput(
  ...
  outputIndex: number,
    ...
    'ScriptError',
    {
      ...
      modName: script.mod.config.name,
      patchId: script.patch?.config.id,
      reason: `Script output #${outputIndex + 1} has invalid generated-block owner paths.`,
      suggestion: 'Use non-empty builder-relative script paths for delegated generated blocks.',
    },
  );
