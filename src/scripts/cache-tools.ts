...
import { CACHE_SALT, readCacheEntry, writeCacheEntryAtomic } from '../engine/cache-store.ts';
import { hashBytes, hashText } from '../hash.ts';
import type { BuildScriptCacheTools, ScriptApplication, ScriptRuntimePlan } from '../types.ts';
