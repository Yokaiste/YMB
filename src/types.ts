...
export interface ErrorContext {
  absolutePath: string;
  /** Stable diagnostic code and position in the NDF file, independent of display wording. */
  code?: string | undefined;
  line?: number | undefined;
  column?: number | undefined;
  offset?: number | undefined;
  /** Authored replacement or generator, when the source is unambiguous. */
...
type BulkConditionOperator =
  'startsWith' | 'endsWith' | 'contains' | 'notContains' | 'equals' | 'notEquals';
