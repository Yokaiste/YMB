...
const COMMAND_GUIDES: CommandGuide[] = [
  ...
  },
  {
    ...
    examples: ['validate', 'validate --mod sample_pack'],
  },
  {
    name: 'list',
  ...
  },
  {
    ...
    examples: ['build', 'build --mod sample_pack --dry-run'],
  },
  {
    name: 'sync',
    ...
    examples: ['sync --yes', 'sync --mod sample_pack --yes'],
  },
  {
    name: 'recover',
    ...
    examples: ['recover --yes', 'recover --mod sample_pack --yes'],
  },
  {
    name: 'cleanup',
    description:
