...
export interface BuildScriptModInfo {
  readonly id: string;
...
export interface BuildScriptPatchInfo {
  readonly id: string;
  readonly name: string;
  readonly description?: string | undefined;
  readonly rootPath: string;
...
export type BuildScriptCollectionAnchor = { before: string } | { after: string };
export type BuildScriptCollectionPosition = 'start' | 'end' | BuildScriptCollectionAnchor;
...
export interface BuildScriptNdfValidationSuccess {
  ok: true;
}

export interface BuildScriptNdfValidationFailure {
  ok: false;
  error: BuildScriptNdfValidationError;
}

// biome-ignore format: Prettier keeps this short named union on one line.
export type BuildScriptNdfValidationResult =
  BuildScriptNdfValidationSuccess | BuildScriptNdfValidationFailure;
...
export type BuildScript = (context: BuildScriptContext) => BuildScriptResult;
...
export type BuildScriptTest = (context: BuildScriptTestContext) => BuildScriptTestResult;
