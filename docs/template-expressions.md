...
For local overrides and nested merge rules, see [customization](configuration.md#customizing-installed-mods).
...
| `pluck(records, field)`                                  | Read one field from every record in order; missing fields are errors |
