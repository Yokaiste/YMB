...
- [Script Tools Reference](script-tools.md) for builder-provided utilities exposed through `context.tools`
...
4. [Workflow Guide](workflow.md)
5. [Configuration Reference](configuration.md)
6. [Script Tools Reference](script-tools.md)
7. [Template Expressions Reference](template-expressions.md)
8. [NDF Operations Reference](ndf-operations.md)
9. [Advanced Guide](advanced.md)
